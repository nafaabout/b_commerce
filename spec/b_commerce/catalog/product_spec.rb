module BCommerce
  module Catalog
    RSpec.describe Product do
      let(:attributes) {
        {
          name: { type: String, length: 1..255},
          type: { values: ["physical", "digital"]},
          sku: { type: String, length: 0..255},
          description: { type: String},
          weight: { type: Float, range: 0..},
          width: { type: Float, range: 0..},
          depth: { type: Float, range: 0..},
          height: { type: Float, range: 0..},
          price: { type: Float, range: 0..},
          ...
          categories: { type: Array, values_type: Integer},
